...
#define USED_BY_OBJDUMP  0x01
#define USED_BY_TEM      0x02
...
extern int print_insn_big_trips		PARAMS ((bfd_vma, disassemble_info*));
extern int print_insn_little_trips	PARAMS ((bfd_vma, disassemble_info*));
