...
target_alias = trips64-linux
target_cpu = trips64
target_vendor = unknown
target_os = linux-gnu
target_canonical = trips64-unknown-linux-gnu
...
tooldir = $(exec_prefix)/trips64-linux
build_tooldir = $(exec_prefix)/trips64-linux

program_transform_name = -e s,^,trips64-linux-, 
...
SUBDIRS =  intl libiberty opcodes bfd gas etc
OTHERS = 
...
TARGET_SUBDIR = trips64-linux

BUILD_CONFIGDIRS = libiberty
BUILD_SUBDIR = i686-pc-linux-gnu

# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=../config.cache --host=trips64-linux --build=i686-pc-linux-gnu --enable-multilib --with-cross-host=i686-pc-linux-gnu   

# This is set by the configure script to the arguments to use when configuring
# directories built for the build system.
BUILD_CONFIGARGS = --cache-file=../config.cache --build=i686-pc-linux-gnu --host=i686-pc-linux-gnu   
...
FLAGS_FOR_TARGET = 
CC_FOR_TARGET = trips64-linux-gcc $(FLAGS_FOR_TARGET)
CXX_FOR_TARGET = trips64-linux-c++ $(FLAGS_FOR_TARGET)
CXX_FOR_TARGET_FOR_RECURSIVE_MAKE = trips64-linux-c++ $(FLAGS_FOR_TARGET)
GCJ_FOR_TARGET = trips64-linux-gcj $(FLAGS_FOR_TARGET)
