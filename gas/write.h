...
extern void number_to_chars_bigendian    PARAMS ((char *, unsigned long long, int));
...
extern fixS *fix_new_exp
  PARAMS ((fragS * frag, int where, int size, expressionS *exp, expressionS *exp2, int pcrel,
