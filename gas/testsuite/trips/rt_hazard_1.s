...
; Purpose:	Checks for all hazards, RAW, WAR and WAW.
;
; 		Loop has nine blocks. Each block reads 32 registers and writes
; 		32 registers.
;
; 		First block reads register set X and writes to another set Y.
; 		Following 8 blocks all read set Y and write set X.
; 		Register set Y tests for RAW, X tests for WAR and WAW.
; Note:		Test generated by a script and not intended to test tsim_arch
;
; Final result should be 0x3ffffffffff
...
;;  set loop count to 20, and clear index
.bbegin _start
